...
summary: The Data Collector Support Matrix contains detailed information on supported Netapp data collectors.
keywords: support matrix, {vendor}
---

= Data Collector Support Matrix - Netapp
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The Data Collector Support Matrix provides reference for NETAPP Data Collectors supported by Data Infrastructure Insights, including vendor and model information.
...
[cols="20,20,20,20,20,20,20,20,20", options="header"]
|===
