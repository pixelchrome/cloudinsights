...
summary: The Data Collector Support Matrix contains detailed information on supported Dell data collectors.
keywords: support matrix, {vendor}
---

= Data Collector Support Matrix - Dell
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The Data Collector Support Matrix provides reference for DELL Data Collectors supported by Data Infrastructure Insights, including vendor and model information.
