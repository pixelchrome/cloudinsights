...
. Sign up for an account on link:https://console.netapp.com//[*NetApp Console*] to get access to all of NetApp's Cloud offerings.
...
** Select *Request trial*. If you are not already registered with Console, Enter your details and sign up. Otherwise, sign in.
...
** link:https://console.netapp.com/contact-cds[NetApp Sales direct]
** AWS Marketplace:
...
For detailed information about Data Infrastructure Insights features and pricing options, see the link:https://www.netapp.com/cloud-services/cloud-insights/editions-pricing[Data Infrastructure Insights Editions] page.
