...
** link:https://www.netapp.com/us/forms/sales-inquiry/cloud-insights-sales-inquiries.aspx[NetApp Sales direct]
** AWS Marketplace:
*** link:[Fixed term subscription]
*** link:[Pay-as-you-go subscription]
*** link:[Fixed base + Pay-as-you-go overages subscription]
** link:[Azure Marketplace] (all subscription options)
