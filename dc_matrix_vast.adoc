...
summary: The Data Collector Support Matrix contains detailed information on supported Vast data collectors.
keywords: support matrix, {vendor}
---

= Data Collector Support Matrix - Vast
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The Data Collector Support Matrix provides reference for VAST Data Collectors supported by Data Infrastructure Insights, including vendor and model information.
