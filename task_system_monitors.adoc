...
Note: If Cloud Insights is reporting an active Acquisition Unit Heartbeat alert, and the AU itself goes down or is uninstalled before that alert is resolved, the alert will remain active. In this case, you must manually dismiss the alert.
