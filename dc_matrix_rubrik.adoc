...
summary: The Data Collector Support Matrix contains detailed information on Rubrik data collectors.
keywords: support matrix, rubrik, collector, matrix
---

= Data Collector Support Matrix for Rubrik
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The Data Collector Support Matrix provides reference for Rubrik Data Collectors.
