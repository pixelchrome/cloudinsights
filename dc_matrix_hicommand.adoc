...
summary: The Data Collector Support Matrix contains detailed information on supported Hicommand data collectors.
keywords: support matrix, {vendor}
---

= Data Collector Support Matrix - Hicommand
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The Data Collector Support Matrix provides reference for HICOMMAND Data Collectors supported by Data Infrastructure Insights, including vendor and model information.
