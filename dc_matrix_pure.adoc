...
summary: The Data Collector Support Matrix contains detailed information on Pure data collectors.
keywords: support matrix, pure, collector, matrix
---

= Data Collector Support Matrix for Pure
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The Data Collector Support Matrix provides reference for Pure Data Collectors.
