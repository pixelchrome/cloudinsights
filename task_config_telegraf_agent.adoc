...
The current Telegraf version for Cloud Insights is *1.22.2*.
...
NOTE: The Kubernetes instructions on this page are moving to a new page. Please link:task_config_telegraf_agent_k8s.html[*go here*] for up-to-date Kubernetes agent instructions.
