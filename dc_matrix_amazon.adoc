...
summary: The Data Collector Support Matrix contains detailed information on supported Amazon data collectors.
keywords: support matrix, {vendor}
---

= Data Collector Support Matrix - Amazon
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The Data Collector Support Matrix provides reference for AMAZON Data Collectors supported by Data Infrastructure Insights, including vendor and model information.
