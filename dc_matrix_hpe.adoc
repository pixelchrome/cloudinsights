...
summary: The Data Collector Support Matrix contains detailed information on supported Hpe data collectors.
keywords: support matrix, {vendor}
---

= Data Collector Support Matrix - Hpe
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The Data Collector Support Matrix provides reference for HPE Data Collectors supported by Data Infrastructure Insights, including vendor and model information.
