...
* Operating Systems including RHEL, CentOS, Windows, and Kubernetes
* Integration data from services such as Docker 
...
== Infrastructure: Install an Acquisition Unit
...
== Infrastructure: Configure the Data Collector
...
== Integration: Configure the Data Collector
