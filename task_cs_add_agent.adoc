...
[cols="1,3"]
|=== 
| Pause and Resume | Pause: Removes fpolicies from ONTAP. Typically used when customers perform extended maintenance activities such as agent VM reboots, which may take several hours or days.
