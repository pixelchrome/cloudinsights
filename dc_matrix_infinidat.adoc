...
summary: The Data Collector Support Matrix contains detailed information on Infinidat data collectors.
keywords: support matrix, infinidat, collector, matrix
---

= Data Collector Support Matrix for Infinidat
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The Data Collector Support Matrix provides reference for Infinidat Data Collectors.
