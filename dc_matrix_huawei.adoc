...
summary: The Data Collector Support Matrix contains detailed information on supported Huawei data collectors.
keywords: support matrix, {vendor}
---

= Data Collector Support Matrix - Huawei
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The Data Collector Support Matrix provides reference for HUAWEI Data Collectors supported by Data Infrastructure Insights, including vendor and model information.
