...
* *Path* of the entity - This should be either exact entity path(e.g., "_/home/userX/nested1/nested2/abc.txt_”) OR directory portion of path for recursive search(e.g., "_/home/userX/nested1/nested2/_”). NOTE: regex path patterns (e.g., *userX*) are NOT allowed here. Directory Path filters (path string ending with /) up to 4 directories deep are recommended for faster results. For example, "_/home/userX/nested1/nested2/_". See the table below for more details.
