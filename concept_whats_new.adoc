...
image:expected_bounds_example_showing_spike.png[expected bounds showing spike above, width=400]
...
Exporting forensics data can take anywhere from a few seconds to a number of hours, depending on the amount of data to export. Workload Security exports that data asynchronously, so you can continue working while the .CSV is being compiled. You will be prompted when the data is ready for you to download. 
