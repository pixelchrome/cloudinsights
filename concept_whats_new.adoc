...
image:widget_analyze_panel.png[Analyze panel for a line widget, width=500]
...
=== Enhanced Cloud Integration: GCNV Data Collector Support  
...
=== Intelligent Monitoring: StorageGrid Enhancements  

Expanded StorageGrid monitoring with over 50 default alerts, real-time event tracking, and new dashboards to simplify complex storage grid operations keeps you ahead of issues by giving you deeper insights into traffic policies and bucket performance.  



=== Smarter Storage Insights: Volume Object Enhancements

Volumes now include host path redundancy checks and fiber channel hop count metrics, making it easier to avoid downtime. New monitors proactively flag risks, ensuring your storage infrastructure remains resilient.


=== Proactive Fabric Management: New Fabric Monitors

New fabric monitors detect physical errors, congestion, and switch failures—ensuring your network infrastructure stays robust and efficient.  
...
////
update "AlmaLinux", "9.3 thru 9.5, including SELinux" to "AlmaLinux", "9.3 thru 9.5, 10, including SELinux"
update ""RedHat", "7.2 thru 7.9, 8.1 thru 8.10, 9.1 thru 9.6 (64bit), including SELinux"" to "RedHat", "7.2 thru 7.9, 8.1 thru 8.10, 9.1 thru 9.6, 10 (64bit), including SELinux"
update "Rocky", "9.0 thru 9.5, including SELinux" to "Rocky", "9.0 thru 9.6, including SELinux"
////
