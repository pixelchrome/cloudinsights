...
image:expected_bounds_disk_example.png[Expected Bounds disk example showing a spike in the chart, width=300
...
image:dii_push_button_upgrade.png[push-button operator upgrade from cluster menu, width=500]
