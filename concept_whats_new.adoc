...
=== Enhanced REST API Usage Tracking
...
To view API Usage, navigate to *Observability > Admin > API Access* and select _View API Usage_.
...
A new API has been added to manage user restriction in Workload Security. With the API you can block or unblock a user, or change the duration of their restricted access. See the Admin > Api Access > API Documentation page for the _clousecure\_actions.block_ API.
