...
=== ONTAP Essentials includes views for ASA devices

The ONTAP Essentials menu pages have been updated for ASA R2 and now have ASA specific views for many of the pages.

image:ontap_essentials_asa_views.png[ONTAP Essentials drop-down showing ASa as separate from Unified]
