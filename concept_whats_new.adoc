...
=== Enhanced contextual menus for easier analysis

Discover our enhanced contextual menus on tables, in the SAN Analyzer and Infrastructure Change Analysis, and on asset pages. Jump directly from asset summaries to detailed logs without the hassle of searching or switching contexts. With instant access to key data across multiple views, you gain a clearer understanding of your SAN environment and object relationships. This streamlined workflow accelerates troubleshooting and decision-making, ultimately saving you time and enhancing your overall analysis process.

image:contextual_menu_in_change_analysis.png[Contextual menu in Change Analysis page]

//Infrastructure Contextual Links (https://jira.ngage.netapp.com/browse/CIS-46163)
