...
image:infra_change_removed_assets.png[removed assets in infra change showing with a strikethrough]

=== Operator Push-Button Upgrade
...
image:dii_push_button_upgrade.png[push-button operator upgrade from cluster menu]
