...
=== VM Optimization adds VSAN support

Have VSAN in your environment? The VM Optimization feature now shows VSAN capacity savings, giving you greater control over cost savings in your environment.

image:vm_optimization_vsan_capacity.png[VSAN Capacity Savings in UI]
