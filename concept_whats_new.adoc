...
Landing pages now provide at-a-glance views of your assets. In addition to collapsible summary data at the top, new sparkline graphs show recent data trends, while Performance charts (formerly "Expert View"), and Additional Resource tables (also collapsible) allow you to quickly and easily view and navigate your environment.

Note that any custom widgets added to a landing page for an asset type are displayed together at the bottom of the screen below the Performance and Additional Resources sections. 

image:lp_new_design.png[new landing page design showing placement of summary, perfromance, and additional resources sections]

TBD

=== Respond quickly to critical security events with Workload Security webhook notifications

Workload Security introduces the ability to send webhook notifications to popular applications such as Slack, Discord, PagerDuty, and Teams, allowing you respond quickly to critical security events, strengthening your security posture.
...
=== ONTAP Essentials for the latest generation of ASA systems 
